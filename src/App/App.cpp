...
//    g_pGui = new mowa::sgui::SimpleGUI(g_pApp);
    ...
    g_pInputP1 = new gen::Input(g_pObjectManager->m_pPlayer1); // always have 2 players for keyboard input
    g_pInputP2 = new gen::Input(g_pObjectManager->m_pPlayer2); // always have 2 players for keyboard input
    InitGamepad();
